...
export declare const enum getUserWishlistErrorMessage {
    NO_WISHLIST_FOUND = "NO_WISHLIST_FOUND"
}
export declare type getUserWishlistResponse = getUserWishlistSuccessResponse | getUserWishlistErrorResponse;
