...
export declare const enum updateWishlistItemErrorMessage {
    CAN_NOT_DELETE_WISHLIST_ITEM = "CAN_NOT_DELETE_WISHLIST_ITEM",
    CAN_NOT_UPDATE_WISHLIST_ITEM = "CAN_NOT_UPDATE_WISHLIST_ITEM"
}
export declare type updateWishlistItemResponse = updateWishlistItemSuccessResponse | updateWishlistItemErrorResponse;
