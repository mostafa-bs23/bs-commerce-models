...
export declare const enum deleteWishlistItemErrorMessage {
    CAN_NOT_DELETE_WISHLIST_ITEM = "CAN_NOT_DELETE_WISHLIST_ITEM"
}
export declare type deleteWishlistItemResponse = deleteWishlistItemSuccessResponse | deleteWishlistItemErrorResponse;
