...
export declare const enum deleteAllWishlistItemsSuccessMessage {
...
export declare const enum deleteAllWishlistItemsErrorMessage {
    CAN_NOT_DELETE_ALL_WISHLIST_ITEMS = "CAN_NOT_DELETE_ALL_WISHLIST_ITEMS"
}
export declare type deleteAllWishlistItemsResponse = deleteAllWishlistItemsSuccessResponse | deleteAllWishlistItemsErrorResponse;
