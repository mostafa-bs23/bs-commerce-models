...
export declare const enum UpdateCustomerErrorMessages {
...
export declare type UpdateCustomerResponse = UpdateCustomerSuccessResponse | UpdateCustomerErrorResponse;
