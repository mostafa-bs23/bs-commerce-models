...
export declare const enum deleteAllCartItemsErrorMessage {
    CAN_NOT_REMOVE_ALL_CART_ITEMS = "CAN_NOT_REMOVE_ALL_CART_ITEMS"
}
export declare type deleteAllCartItemsResponse = deleteAllCartItemsSuccessResponse | deleteAllCartItemsErrorResponse;
