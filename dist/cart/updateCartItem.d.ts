...
export declare const enum updateCartItemErrorMessage {
    CAN_NOT_UPDATE_CART_ITEM = "CAN_NOT_UPDATE_CART_ITEM",
    CAN_NOT_REMOVE_CART_ITEM = "CAN_NOT_REMOVE_CART_ITEM"
}
export declare type updateCartItemResponse = updateCartItemSuccessResponse | updateCartItemErrorResponse;
