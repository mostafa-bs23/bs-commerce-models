...
export declare const enum GetProductsByConditionErrorMessages {
...
export declare type GetProductsByConditionResponse = GetProductsByConditionSuccessResponse | GetProductsByConditionErrorResponse;
