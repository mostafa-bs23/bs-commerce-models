...
export declare const enum SignUpSuccessMessages {
...
export declare const enum SignUpErrorMessages {
...
export declare type CreateUserResponse = CreateUserSuccessResponse | CreateUserErrorResponse;
