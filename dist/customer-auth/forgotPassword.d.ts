...
export declare const enum CustomerForgotPasswordSuccessMessages {
    FORGOT_PASSWORD_SUCCESSFUL = "FORGOT_PASSWORD_SUCCESSFUL"
}
export declare const enum CustomerForgotPasswordErrorMessages {
...
export declare type CustomerForgotPasswordResponse = CustomerForgotPasswordSuccessResponse | CustomerForgotPasswordErrorResponse;
