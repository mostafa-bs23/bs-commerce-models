...
export declare const enum CreateCustomerSuccessMessages {
...
export declare const enum CreateCustomerErrorMessages {
...
export declare type CreateCustomerResponse = CreateCustomerSuccessResponse | CreateCustomerErrorResponse;
