...
export declare const enum getCategoryBySlugErrorMessage {
    CAN_NOT_GET_CATEGORY_BY_SLUG = "CAN_NOT_GET_CATEGORY_BY_SLUG"
}
export declare type getCategoryBySlugResponse = getCategoryBySlugSuccessResponse | getCategoryBySlugErrorResponse;
