...
export declare const enum getCategoryListErrorMessage {
    CAN_NOT_GET_CATEGORY_LIST = "CAN_NOT_GET_CATEGORY_LIST"
}
export declare type getCategoryListResponse = getCategoryListSuccessResponse | getCategoryListErrorResponse;
