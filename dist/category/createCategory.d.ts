...
export declare const enum createCategoryErrorMessage {
    CAN_NOT_CREATE_CATEGORY = "CAN_NOT_CREATE_CATEGORY"
}
export declare type createCategoryResponse = createCategorySuccessResponse | createCategoryErrorResponse;
